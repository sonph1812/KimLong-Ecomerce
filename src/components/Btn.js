  ...
  return (
    <>
      ...
      >
        ...
        <span
          className="absolute bottom-0 right-0 w-full h-12 -mb-1 -mr-1 transition-all duration-300 ease-in-out bg-gray-900 rounded-lg group-hover:mb-0 group-hover:mr-0"
